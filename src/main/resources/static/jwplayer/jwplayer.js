...
jwplayer.version = "8", jwplayer.vid = document.createElement("video"), jwplayer.audio = document.createElement("audio"), jwplayer.source = document.createElement("source"),
function(d) {
    function a(b) {
        return function() {
            return c(b)
    ...
    function f(m, a, e, g) {
        return function() {
            ...
            } catch(j) {} (c = b.parseXML(m.responseText)) && c.firstChild ? (m = b.extend({},
            m, {
                responseXML: c
    ...
    b.getCookies = function() {
        for (var b = {},
        a = h.cookie.split("; "), e = 0; e < a.length; e++) {
            var g = a[e].split("\x3d");
    ...
    b.deepReplaceKeyName = function(a, c, e) {
        ...
        case "object":
            ...
            function(b, g) {
                ...
                for (var f = b,
                h = 0; h < j.length; h++) f = f.replace(RegExp(c[h], "g"), e[h]);
    ...
    b.ajax = function(a, c, j) {
        ...
        if (h && b.exists(e.XDomainRequest)) g = new XDomainRequest,
        g.onload = f(g, a, c, j),
        g.onerror = k(j, a, g);
    ...
    b.filterPlaylist = function(a, c) {
        ...
        if (c && 0 == e.length) for (g = 0; g < a.length; g++) if (j = b.extend({},
        a[g]), j.sources = b.filterSources(j.sources, !0), 0 < j.sources.length) {
            for (f = 0; f < j.sources.length; f++) h = j.sources[f],
            h.label || (h.label = f.toString());
            e.push(j)
        }
        return e
    ...
    b.filterSources = function(a, c) {
        ...
        if (a) {
            ...
            for (var f = 0; f < a.length; f++) {
                ...
                c ? d.embed.flashCanPlay(n, h) && (e || (e = h), h == e && g.push(b.extend({},
                a[f]))) : b.canPlayHTML5(h) && (e || (e = h), h == e && g.push(b.extend({},
                a[f])))
            }
        }
        return g
...
function(d) {
    ...
    d.scriptloader = function(f) {
        ...
        this.load = function() {
            ...
            if (c && (c.getStatus() == a.NEW || c.getStatus() == a.LOADING)) c.addEventListener(b.ERROR, h),
            c.addEventListener(b.COMPLETE, e);
            else if (d.scriptloader.loaders[f] = this, j == a.NEW) {
                j = a.LOADING;
                var m = k.createElement("script");
                m.addEventListener ? (m.onload = e, m.onerror = h) : m.readyState && (m.onreadystatechange = function() { ("loaded" == m.readyState || "complete" == m.readyState) && e()
                });
...
function(d) {
    ...
    d.xmlAttribute = function(a, d) {
        for (var f = 0; f < a.attributes.length; f++) if (a.attributes[f].name && a.attributes[f].name.toLowerCase() == d.toLowerCase()) return a.attributes[f].value.toString();
        return ""
    };
...
function(d) {
    ...
    d.touch = function(f) {
        function h(b) {
            b.type == k ? (c = !0, m = j(l.DRAG_START, b)) : b.type == a ? c && (p || (e(l.DRAG_START, b, m), p = !0), e(l.DRAG, b)) : (c && (p ? e(l.DRAG_END, b) : (b.cancelBubble = !0, e(l.TAP, b))), c = p = !1, m = null)
        }
        function e(a, b, c) {
...
function(d) {
    d.key = function(a) {
        ...
        try {
            ...
            var e = a.split("/"); (k = e[0]) ? /^(free|pro|premium|ads)$/i.test(k) ? (f = e[1], e[2] && 0 < parseInt(e[2]) && (h = new Date, h.setTime(String(e[2])))) : k = "invalid": k = "free"
        } catch(j) {
            k = "invalid"
        }
    }
...
function(d) {
    ...
    a.decrypt = function(h, e) {
        ...
        for (var j = a.strToLongs(k.decode(h)), b = a.strToLongs(f.encode(e).slice(0, 16)), c = j.length, d = j[c - 1], m = j[0], p, l = 2654435769 * Math.floor(6 + 52 / c); 0 != l;) {
            p = l >>> 2 & 3;
            for (var g = c - 1; 0 <= g; g--) d = j[0 < g ? g - 1 : c - 1],
    ...
    var k = {
        ...
        encode: function(a, e) {
            ...
            g += "\x00";
            for (l = 0; l < g.length; l += 3) j = g.charCodeAt(l),
            b = g.charCodeAt(l + 1),
            c = g.charCodeAt(l + 2),
            d = j << 16 | b << 8 | c,
            j = d >> 18 & 63,
        ...
        decode: function(a, e) {
            ...
            g = k.code;
            l = e ? f.decode(a) : a;
            for (var q = 0; q < l.length; q += 4) j = g.indexOf(l.charAt(q)),
...
function(d) {
    ...
    d.eventdispatcher = function(d, f) {
        ...
        this.sendEvent = function(j, b) {
            ...
            f && a.log(j, b);
            if ("undefined" != a.typeOf(h[j])) for (var c = 0; c < h[j].length; c++) {
                try {
                    h[j][c].listener(b)
                } catch(n) {
    ...
    d.plugins.pluginloader = function(h, e) {
        ...
        function b() {
            ...
            if (!n && !m) {
                ...
                function(e) {
                    ...
                    else if (e && (!g || parseFloat(g) > parseFloat(d.version))) m = !0,
        ...
        this.setupPlugins = function(b, c, e) {
            ...
            function(f, h) {
                ...
                q = l.getJS(),
                p = l.getURL();
                m && (g.plugins[m] = a.extend({},
                h), g.plugins[m].pluginmode = l.getPluginmode(), g.length++);
                try {
                    if (q && c.plugins && c.plugins[p]) {
                        ...
                        A.style.top = 0;
                        A.style.zIndex = j + 10;
                        d[k] = l.getNewInstance(b, a.extend({},
                        c.plugins[p]), A);
                        j++;
                        b.onReady(e(d[k], A, !0));
                        b.onResize(e(d[k], A))
...
function(d) {
    ...
    j.parseGroup = function(b, c) {
        var d, m, p = [];
        for (m = 0; m < e(b); m++) if (d = b.childNodes[m], "media" == d.prefix && f(d)) switch (f(d).toLowerCase()) {
        case "content":
...
function(d) {
    ...
    d.rssparser.parse = function(b) {
        for (var c = [], f = 0; f < e(b); f++) {
            var d = h(b, f);
            if ("channel" == j(d).toLowerCase()) for (var k = 0; k < e(d); k++) {
                var l = h(d, k);
...
function(d) {
    d.playlist = function(a) {
        var k = [];
        if ("array" == d.utils.typeOf(a)) for (var f = 0; f < a.length; f++) k.push(new d.playlist.item(a[f]));
...
function(d) {
    ...
    j = d.embed = function(b) {
        ...
        function n() {
            ...
            if ("array" == a.typeOf(r.playlist) && 2 > r.playlist.length && (0 == r.playlist.length || !r.playlist[0].sources || 0 == r.playlist[0].sources.length)) p();
            else if (!z) if ("string" == a.typeOf(r.playlist)) {
                var g = new d.playlist.loader;
                g.addEventListener(k.JWPLAYER_PLAYLIST_LOADED,
                function(a) {
                    r.playlist = a.playlist;
                    z = h;
                    n()
                });
                g.addEventListener(k.JWPLAYER_ERROR,
                function(a) {
                    z = h;
                    p(a)
                });
                ...
                for (g = 0; g < r.modes.length; g++) if (r.modes[g].type && j[r.modes[g].type]) {
                    ...
                    if (w.supportsConfig()) return w.addEventListener(k.ERROR, m),
                    w.embed(),
                    c(b, u.events),
                    b
                }
                ...
                } else x = "No suitable players found and fallback disabled",
                q(x, h),
                a.log(x),
...
function(d) {
    function a(a) {
        if (a.playlist) for (var d = 0; d < a.playlist.length; d++) a.playlist[d] = new h(a.playlist[d]);
        else {
            var b = {};
            ...
            b.sources || (a.levels ? (b.sources = a.levels, delete a.levels) : (d = {},
            k(a, d, "file"), k(a, d, "type"), b.sources = d.file ? [d] : []));
            a.playlist = [new h(b)]
        }
    }
    function k(a, d, b) {
    ...
    var f = d.utils,
    h = d.playlist.item; (d.embed.config = function(e) {
        var j = {
            fallback: !0,
            height: 270,
            primary: "html5",
    ...
    d.embed.download = function(d, h, e) {
        ...
        if (c && c.length) {
            ...
            for (c = 0; c < p.length; c++) {
                ...
                u.file && a.foreach(t,
                function(b) {
                    v == t[b] ? (l = u.file, g = r.image) : a.isYouTube(u.file) && (q = u.file)
                })
            }
...
function(d) {
    var a = d.utils,
    k = d.events,
    f = {}; (d.embed.flash = function(e, j, b, c, n) {
        function m(a, b, c) {
        ...
        this.supportsConfig = function() {
            if (q) if (b) {
                ...
                try {
                    ...
                    for (var d = 0; d < c.length; d++) if (c[d].file && h(c[d].file, c[d].type)) return ! 0
                } catch(e) {}
            } else return ! 0;
            return ! 1
        }
...
function(d) {
    ...
    f = k.extend(function(f) {
        ...
        case "premium":
        case "ads":
            b.related && (b.related.client && b.related.client.match(".js$|.swf$") && (g = b.related.client), n[g] = b.related),
            b.ga && (b.ga.client && b.ga.client.match(".js$|.swf$") && (q = b.ga.client), n[q] = b.ga),
            c.sitecatalyst && new d.embed.sitecatalyst(f);
        case "pro":
            b.sharing && (b.sharing.client && b.sharing.client.match(".js$|.swf$") && (l = b.sharing.client), n[l] = b.sharing),
...
function(d) {
    ...
    j = d.api = function(a) {
        ...
        function n(a, b) {
            r[a] || (r[a] = [], p(f.JWPLAYER_PLAYER_STATE,
            function(b) {
                var c = b.newstate;
                b = b.oldstate;
                if (c == a) {
        ...
        g.dispatchEvent = function(a, b) {
            if (q[a]) for (var c = k.translateEventResponse(a, b), d = 0; d < q[a].length; d++) if ("function" == typeof q[a][d]) try {
    ...
    j.destroyPlayer = function(b) {
        for (var c = -1,
        d, f = 0; f < a.length; f++) a[f].id == b && (c = f, d = a[f]);
