(function(f) {
    ...
    f.transform = function(b, a) {
        ...
        a = a ? a: "";
        "string" == typeof b ? (c = {},
        c["-webkit" + d] = a, c["-ms" + d] = a, c["-moz" + d] = a, c["-o" + d] = a, f.css(b, c)) : (d = "Transform", c = b.style, c["webkit" + d] = a, c["Moz" + d] = a, c["ms" + d] = a, c["O" + d] = a)
    };
    ...
    f.stretch = function(b, e, c, a, d, r) {
        if (e && (b || (b = g.UNIFORM), c && a && d && r)) {
            ...
            case g.EXACTFIT:
                ...
                break;
            default:
                j > h ? 0.95 < d * h / c ? (A = !0, n = "jwexactfit") : (d *= h, r *= h) : 0.95 < r * j / a ? (A = !0, n = "jwexactfit") : (d *= j, r *= j),
                A && (h = Math.ceil(100 * a / r) / 100, j = Math.ceil(100 * c / d) / 100)
            }
    ...
    f.dfxp = function(g, b) {
        ...
        e.onreadystatechange = function() {
            if (4 === e.readyState) if (200 === e.status) {
                for (var d = e.responseText,
                r = [{
                    begin: 0,
                    text: ""
                }], d = d.replace(/^\s+/, "").replace(/\s+$/, ""), j = d.split("\x3c/p\x3e"), h = d.split("\x3c/tt:p\x3e"), q = [], d = 0; d < j.length; d++) 0 <= j[d].indexOf("\x3cp") && (j[d] = j[d].substr(j[d].indexOf("\x3cp") + 2).replace(/^\s+/, "").replace(/\s+$/, ""), q.push(j[d]));
            ...
            0 == r ? b("Crossdomain loading denied: " + c) : 404 == r ? b("DFXP File not found: " + c) : b("Error " + r + " loading DFXP file: " + c)
        }
    }
    ...
    f.srt = function(g, b, e) {
        ...
        function a(a) {
            ...
            for (a = 0; a < c.length; a++) if ("WEBVTT" != c[a]) {
                var j, k = c[a];
                j = {};
                var p = k.split("\r\n");
    ...
    f.captions = function(a, h) {
        ...
        function f(a) { (G = a.fullscreen) ? (n(), setTimeout(n, 500)) : l(!0)
        }
        function n() {
        ...
        function y(a) {
            ...
            for (; a.nodeType == a.COMMENT_NODE;) a = a.nextSibling; ("tt" == c.localName(a) ? new jwplayer.parsers.dfxp(p, q) : new jwplayer.parsers.srt(p, q)).load(C)
        }
        function k() { (new jwplayer.parsers.srt(p, q)).load(C)
        }
        function p(a) {
            s.populate(a);
        ...
        a.jwAddEventListener(b.JWPLAYER_PLAYER_STATE,
        function(a) {
            switch (a.newstate) {
            case e.IDLE:
                v = "idle";
        ...
        a.jwAddEventListener(b.JWPLAYER_PLAYLIST_ITEM,
        function() {
            z = 0;
            u = [];
            s.update(0);
            for (var c = a.jwGetPlaylist()[a.jwGetPlaylistIndex()].tracks, d = [], e = 0, k = "", m = 0, k = "", e = 0; e < c.length; e++) k = c[e].kind.toLowerCase(),
            ("captions" == k || "subtitles" == k) && d.push(c[e]);
            for (e = B = 0; e < d.length; e++) if (k = d[e].file) d[e].label || (d[e].label = e.toString()),
            u.push(d[e]);
            for (e = 0; e < u.length; e++) if (u[e]["default"]) {
                m = e + 1;
                break
            }
            if (k = g.getCookies().captionLabel) {
                c = w();
                for (e = 0; e < c.length; e++) if (k == c[e].label) {
                    m = e;
                    break
                }
            }
        ...
        a.jwAddEventListener(b.JWPLAYER_READY,
        function() {
            g.foreach(x,
            function(a, b) {
                h && void 0 != h[a.toLowerCase()] ? "color" == a ? m.color = "#" + String(h.color).substr( - 6) : m[a] = h[a.toLowerCase()] : m[a] = b
            });
            s = new jwplayer.html5.captions.renderer(m, D);
            l(!1)
        });
        a.jwAddEventListener(b.JWPLAYER_MEDIA_TIME,
        function(a) {
            s.update(a.position)
        });
        a.jwAddEventListener(b.JWPLAYER_FULLSCREEN, f);
        a.jwAddEventListener(b.JWPLAYER_RESIZE,
        function() {
            l(!1)
        })
    };
    ...
    f.captions.renderer = function(b, e) {
        ...
        function d() {
            for (var a = -1,
            b = 0; b < j.length; b++) if (j[b].begin <= n && (b == j.length - 1 || j[b + 1].begin >= n)) {
                a = b;
                break
    ...
    g.controlbar = function(f, m) {
        ...
        function M() {
            W = b.extend({},
            Ea, oa.getComponentSettings("controlbar"), m);
        ...
        function ba(c, g, k, j) {
            if (d) {
                var m = c.element();
                g.appendChild(m); (new b.touch(g)).addEventListener(b.touchEvents.TAP,
                function() {
        ...
        function ta(c) {
            ...
            if (Ba[c]) {
                var e = Ba[c],
                k = Ja[c];
                if (e && 0 < e.elements.length) for (var m = 0; m < e.elements.length; m++) {
                    var f;
                    a: {
                        f = e.elements[m];
                        var C = c;
                        ...
                        case j:
                            if ("blank" != f.name) {
                                f = f.name;
                                s = C;
                                if (!N(f + "Button").src || d && ("mute" == f || 0 == f.indexOf("volume")) || r && /hd|cc/.test(f)) f = I;
                                else {
                                    var C = P(),
                                    l = P(),
                                    J = void 0,
                                    ...
                                    s = N(f + "Button");
                                    l = N(f + "ButtonOver");
                                    O(F(".jw" + f + " button"), s, l); (s = mb[f]) && O(F(".jw" + f + ".jwtoggle button"), N(s + "Button"), N(s + "ButtonOver"));
                                    f = L[f] = C
                                }
                                break a
                            }
        ...
        $.show = function(c) {
            if (!$.visible || c) clearTimeout(Pa),
            Pa = t,
            $.visible = !0,
            S.style.display = "inline-block",
            Aa(),
            z(),
            S && S.querySelector(".jwalt") && (320 <= b.bounds(S.parentNode).width && !S.querySelector(".jwalt").innerHTML ? a(F(".jwhidden"), k) : a(F(".jwhidden"), n)),
        ...
        H.jwAddEventListener(e.JWPLAYER_PLAYER_STATE,
        function(b) {
            switch (b.newstate) {
            case c.BUFFERING:
            case c.PLAYING:
        ...
        H.jwAddEventListener(e.JWPLAYER_PLAYLIST_ITEM,
        function(a) {
            a = H.jwGetPlaylist()[a.index].tracks;
            if ("array" == b.typeOf(a) && !d) for (var c = 0; c < a.length; c++) if (a[c].file && a[c].kind && "thumbnails" == a[c].kind.toLowerCase()) {
                Wa.load(a[c].file);
                return
            }
            Wa.load()
        ...
        H.jwAddEventListener(e.JWPLAYER_MEDIA_BUFFER,
        function(a) {
            Ca(a.bufferPercent / 100)
        });
        H.jwAddEventListener(e.JWPLAYER_FULLSCREEN,
        function(a) {
        ...
        H.jwAddEventListener(e.JWPLAYER_CAPTIONS_LIST,
        function(b) {
    ...
    f.html5.controller = function(r, j) {
        ...
        function q(d) {
            ...
            case "string":
                var e = new c.loader;
                e.addEventListener(b.JWPLAYER_PLAYLIST_LOADED,
                function(a) {
                    q(a.playlist)
                });
                e.addEventListener(b.JWPLAYER_ERROR,
                function(a) {
                    q([]);
        ...
        function n(c) {
            z = null;
            try {
                return w.state != e.IDLE ? D.stop() : c || (u = a),
                v && (B = a),
                a
            } catch(g) {
        ...
        this.playerReady = function(b) {
            if (!m) {
                ...
                for (m = a; 0 < G.length;) b = G.shift(),
                t(b.method, b.arguments)
            }
        };
        w.addEventListener(b.JWPLAYER_MEDIA_BUFFER_FULL,
        function() {
            D.play()
        });
        w.addEventListener(b.JWPLAYER_MEDIA_COMPLETE,
        function() {
            setTimeout(l, 25)
        });
        w.addEventListener(b.JWPLAYER_MEDIA_ERROR,
        function(a) {
            a = g.extend({},
            a);
    ...
    f.display = function(q, A) {
        ...
        x.jwAddEventListener(b.JWPLAYER_PLAYLIST_ITEM,
        function() {
            F = h;
            M.error && M.error.setText();
        ...
        x.jwAddEventListener(b.JWPLAYER_PLAYLIST_COMPLETE,
        function() {
            P = j;
            y("replay");
    ...
    f.displayicon = function(f, j, h, q) {
        ...
        function y(a, c, d, e) {
            ...
            f.src ? (d = g.extend({},
            d), 0 < a.indexOf("Icon") && (G = f.width), d["background-image"] = "url(" + f.src + ")", d["background-size"] = f.width + "px " + f.height + "px", d.width = f.width, b(A(c), d), e = g.extend({},
            e), f.overSrc && (e["background-image"] = "url(" + f.overSrc + ")"), g.isMobile() || b("#" + t.id + " .jwdisplay:hover " + (c ? c: A()), e), b(A(), {
                display: "table"
            },
            !0)) : b(A(), {
                display: "none"
        ...
        function l(a) {
            if (0 >= M) clearInterval(C);
                ...
                M--;
                var c = Math.max(B.width, g.bounds(x).width - s.width - m.width); (g.isFF() || g.isIE()) && c++;
        ...
        this.setText = function(a) {
            ...
            b.height = "0";
            b.display = "block";
            if (a) for (; 2 < Math.floor(z.scrollHeight / c.defaultView.getComputedStyle(z, null).lineHeight.replace("px", ""));) z.innerHTML = z.innerHTML.replace(/(.*) .*$/, "$1...");
            b.height = "";
            b.display = "";
            p()
        };
    ...
    f.dock = function(j, h) {
        ...
        z.show = function() { ! z.visible && w && (z.visible = !0, m.style.display = r, clearTimeout(v), v = setTimeout(function() {
                m.style.opacity = 1
            },
            0))
        };
        z.addButton = function(a, c, d, k) {
            if (!D[k]) {
                ...
                g.isMobile() ? (new g.touch(l)).addEventListener(g.touchEvents.TAP,
                function(a) {
                    d(a)
    ...
    f.instream = function(d, g, j, h) {
        function q(a) {
            a.type == e.JWPLAYER_MEDIA_ERROR && (a = b.extend({},
            a), a.type = e.JWPLAYER_ERROR);
            l(a.type, a);
            O = !0;
        ...
        function l(a, b, c) { (C || c) && M.sendEvent(a, b)
        }
        function I() {
            B && B.redraw();
            G && G.redraw()
        ...
        E.load = function(j, M) {
            ...
            }) : (C = !0, D = b.extend(t, M), w = new a.item(j), F = document.createElement("div"), F.id = E.id + "_instream_container", m = h.detachMedia(), u = new f.video(m), u.addGlobalListener(n), u.addEventListener(e.JWPLAYER_MEDIA_META, p), u.addEventListener(e.JWPLAYER_MEDIA_COMPLETE, k), u.addEventListener(e.JWPLAYER_MEDIA_BUFFER_FULL, y), u.addEventListener(e.JWPLAYER_MEDIA_ERROR, q), u.addEventListener(e.JWPLAYER_PLAYER_STATE, A), u.attachMedia(), u.mute(g.mute), u.volume(g.volume), P = new f.model({},
            u), P.setVolume(g.volume), P.setMute(g.mute), P.addEventListener(e.JWPLAYER_ERROR, q), z = g.playlist[g.item], v = g.getVideo().checkComplete() ? c.IDLE: d.jwGetState(), h.checkBeforePlay() && (v = c.PLAYING, U = !1), s = m.currentTime, P.setPlaylist([j]), O || ((v == c.BUFFERING || v == c.PLAYING) && m.pause(), G = new f.display(E), G.setAlternateClickHandler(function(a) {
        ...
        E.jwInstreamDestroy = function(a) {
            if (C) {
                ...
                !0);
                h.attachMedia();
                if (v == c.BUFFERING || v == c.PLAYING) m.play(),
                g.playlist[g.item] == z && U && g.getVideo().seek(s)
            }
        };
        ...
        d.jwAddEventListener(e.JWPLAYER_FULLSCREEN,
        function(a) {
            n(a);
            I();
    ...
    c = f.html5.logo = function(a, d) {
        ...
        if ("o" == k || "f" == k) n.link = "http://www.xiaolaoshu.cc";
        q = g.extend({},
        n, d);
    ...
    f.model = function(e, c) {
        ...
        d.setItem = function(a) {
            ...
            if (c || a != d.item) d.item = a,
            d.sendEvent(b.JWPLAYER_PLAYLIST_ITEM, {
                index: d.item
            })
        };
    ...
    f.html5.overlay = function(e, f, y) {
        ...
        z, u, B = y;
        e = g.extend({},
        q, D.getComponentSettings("tooltip"));
        var G = {},
        C = this;
        C.element = function() {
            return m
    ...
    f.player = function(b) {
        function e(a) {
            ...
            b.sources = [];
            b.tracks = [];
            0 < a.sources.length && g.foreach(a.sources,
            function(a, c) {
                b.sources.push({
                    file: c.file,
            ...
            0 < a.tracks.length && g.foreach(a.tracks,
            function(a, c) {
                b.tracks.push({
                    file: c.file,
        ...
        a.jwGetPlaylist = function() {
            for (var a = d.playlist,
            c = [], b = 0; b < a.length; b++) c.push(e(a[b]));
            return c
        };
        ...
        b = new f.setup(d, r, j);
        b.addEventListener(jwplayer.events.JWPLAYER_READY,
        function(a) {
            j.playerReady(a);
            g.css.unblock()
        });
        b.addEventListener(jwplayer.events.JWPLAYER_ERROR,
        function(a) {
    ...
    f.playlistcomponent = function(r, j) {
        ...
        y = n.skin,
        k = e.extend({},
        g, n.skin.getComponentSettings("playlist"), j),
        p,
        l,
        I,
        t,
        ...
        n.jwAddEventListener(b.JWPLAYER_PLAYLIST_LOADED,
        function() {
            l.innerHTML = "";
        ...
        n.jwAddEventListener(b.JWPLAYER_PLAYLIST_ITEM,
        function(a) {
    ...
    f.rightclick = function(a, b) {
        ...
        var h, q = g.extend({
            aboutlink: "http://www.xiaolaoshu.cc",
            abouttext: "About XiaoLaoShu.cc"
        },
        b),
        A = !1,
        n,
        ...
        function q() {
            for (var a = 0; a < D.length; a++) {
                ...
                a: {
                    if (c = b.depends) {
                        c = c.toString().split(",");
                        for (var d = 0; d < c.length; d++) if (!l[c[d]]) {
                            c = !1;
                            break a
                        }
                    }
    ...
    f.skinloader = function(c, a, d) {
        ...
        function h(a) {
            ...
            0 < b && (x = b); (!c || parseFloat(c) > parseFloat(jwplayer.version)) && p("Incompatible player version");
            if (0 === a.length) k(y);
        ...
        function q() {
            ...
            w || (I = setInterval(function() {
                ...
                function(c, d) {
                    ...
                    function(b) { (y[n(c)] ? y[n(c)].elements[n(b)] : null).ready || (a = !1)
                    })
                });
    ...
    f.thumbs = function(c) {
        ...
        this.updateTimeline = function(a) {
            ...
            if (h) {
                ...
                b == h.length && b--;
                if (h[b].text) if (a = h[b].text, 0 > a.indexOf("://") && (a = q ? q + "/" + a: a), 0 < a.indexOf("#xywh")) try {
    ...
    f.html5.video = function(d) {
        ...
        w = {
            ...
            ratechange: j,
            readystatechange: j,
            seeked: function() { ! G && C != e.PAUSED && l(e.PLAYING)
            },
            seeking: t ? y: j,
            stalled: j,
            suspend: j,
        ...
        Q.load = function(a) {
            if (O) {
                ...
                U = D.sources;
                0 > J && (J = 0);
                for (a = 0; a < U.length; a++) if (U[a]["default"]) {
                    J = a;
                    break
                }
                var c = g.getCookies().qualityLabel;
                if (c) for (a = 0; a < U.length; a++) if (U[a].label == c) {
                    J = a;
                    break
    ...
    f.view = function(D, x) {
        ...
        function z() {
            clearTimeout(ma);
            if (X.jwGetState() == e.PAUSED || X.jwGetState() == e.PLAYING) Y(),
            ua || (ma = setTimeout(Q, Ia))
        }
        function u() {
            clearTimeout(ma);
            ua = p
        ...
        function O() {
            ...
            a: {
                ...
                for (var b = 0; b < a.length; b++) if (a[b] && (!a[b].id || a[b].id == X.id)) {
                    a = p;
                    break a
                }
                a = l
        ...
        function Q() {
            ...
            ma = 0;
            L = l;
            var a = X.jwGetState(); (!x.controls || a != e.PAUSED) && U();
            x.controls || N && !wa && N.hide();
            a != e.IDLE && a != e.PAUSED && (N && !wa && N.hide(), H && H.hide(W))
        }
        function Y() {
            L = p;
            if ((K.controls || W) && !(r && La == e.PAUSED))(!r || W) && R && R.show(),
            J();
            oa.hide && H && !W && H.show()
        }
        function da(a) { (a = a && !W) || j ? c(qa(y), {
                visibility: "visible",
                opacity: 1
            }) : c(qa(y), {
                visibility: I,
        ...
        this.setup = function(d) {
            if (!Ba) {
                ...
                V = new f.display(X, j);
                V.addEventListener(b.JWPLAYER_DISPLAY_CLICK,
                function(b) {
                    G(b);
                ...
                a || (ra.addEventListener("mouseout",
                function() {
                    clearTimeout(ma);
                    ma = setTimeout(Q, 10)
                },
        ...
        this.getSafeRegion = function() {
            ...
            e = Math.max(e ? f.top + f.height - c: 0, j ? h.top + h.height - c: 0),
            f = b.width,
    ...
    f.rightclick = function(e, c) {
        if ("free" == e.edition()) c.aboutlink = "http://www.xiaolaoshu.cc",
        delete c.abouttext;
        else {
            if (!c.aboutlink) {
                var a = "http://www.xiaolaoshu.cc",
                d = e.edition();
                c.aboutlink = a + ("pro" == d ? "p": "premium" == d ? "r": "ads" == d ? "a": "f")
            }
            c.abouttext ? c.abouttext = "About " + c.abouttext + " ...": (a = e.edition(), a = a.charAt(0).toUpperCase() + a.substr(1), c.abouttext = "About XiaoLaoShu.cc")
        }
        g(this, new b(e, c))
    }
})(jwplayer.html5); (function(f) {
